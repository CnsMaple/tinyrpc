...
const char descriptor_table_protodef_hello_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\032\016.HelloResponseB\003\200\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_hello_2eproto = {
  false, false, 149, descriptor_table_protodef_hello_2eproto, "hello.proto", 
    ...
    case 0:
      SayHello(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::HelloRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::HelloResponse*>(
                 response),
             done);
      break;
    default:
